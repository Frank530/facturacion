...
<nav class="navbar navbar-default navbar-static-top navbar-inverse" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo site_url();?>/Procesos/inicio">Sistema De Informacion Para Ventas</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?php echo site_url();?>/Procesos/producto"><i class="glyphicon glyphicon-book"></i> Productos</a>
                </li>
                <li>
                ...
                <li>
                    <a href="tables.html"><i class="fa fa-users fa-fw"></i> Clientes</a>
                </li>
